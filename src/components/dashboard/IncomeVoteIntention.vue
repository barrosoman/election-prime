<template>
  <Card
    :title="{ title: `Intenções de Voto à ${this.target} por Renda Salarial` }"
    :subtitle="{
      subtitle: `Consulte as intenções de voto à ${this.target.toLowerCase()} por renda salarial`
    }"
  >
  ...
  data() {
    return {
      ...
      chartOptions: {
        ...
        xaxis: {
          categories: ['até 2', '3-4', '5-6', '7-10', 'maior que 10']
        },
        yaxis: {
          title: {
            text: undefined
